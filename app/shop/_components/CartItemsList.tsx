...
interface Props {
  ...
  readOnly?: boolean;
  /** Mappa { itemId → messaggio errore }. Renderizzata sotto ogni card pertinente. */
  itemErrors?: ReadonlyMap<string, string>;
}

export default function CartItemsList({ items, onRemove, onUpdateQty, readOnly = false, itemErrors }: Props) {
